...
const EventCards = () => {
  ...
  return (
    ...
    >
      <h1>Events</h1>
      {(past.length === 0 && upcoming.length === 0) ? <p>events loading ... </p> :
      <div
      className="eventGrid"
      style={{
        display: "grid",
    ...
    >
      <div style={{ maxWidth: "25rem", display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        ...
        >
          ...
          >
            <h1 style={{ color: "white", margin: 0 }}>{eventExpand[event].day}</h1>
            <h1 style={{ color: "white", margin: 0 }}>{eventExpand[event].month}</h1>
          </div>
          <div
            style={{
              padding: "1rem",
          ...
          >
            ...
            <p style={{ marginBottom: '0.5rem', fontSize: '1.125rem' }}>{event}</p>
            <p style={{ margin: 0 }}>
              {eventExpand[event].desc}
            </p>
          </div>
        </div>
        )})}
